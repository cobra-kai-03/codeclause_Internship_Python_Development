...
def BookList():
    ...
    try:
        bookFile = open('python bootcamp//src//BookList.txt')
        bookFile.close()
        ...
        bookListRoot.iconbitmap('python bootcamp//src//Icon.ico')
        ...
        with open('python bootcamp//src//BookList.txt') as bookListFileTreeview:
...
def SearchBook():
    ...
    try:
        ...
        bookSearchRoot.iconbitmap('python bootcamp//src//Icon.ico')
...
def Search():
    ...
    if len(searchID) == 3:
        try:
            dicSearch = {}
            booksInfoSearch = getbooksinfo('python bootcamp//src//BookList.txt' , dicSearch)
...
def BorrowBook(): 
    ...
    try:
        ...
        bookBorrowRoot.iconbitmap('python bootcamp//src//Icon.ico')
...
def Borrow():
    ...
    if len(borrowID) == 3:
        try:
            dicBorrow = {}
            booksInfoBorrow = getbooksinfo('python bootcamp//src//BookList.txt' , dicBorrow)
            if booksInfoBorrow[borrowID][-1] == 'not taken':
                new_file = []
                with open('python bootcamp//src//BookList.txt' , 'r') as file:
                    for line in file:
                        if line[ : 3] == borrowID:
                ...
                file.close()
                with open('python bootcamp//src//BookList.txt' , 'w') as file:
...
def ReturnBook(): 
    ...
    try:
        ...
        bookReturnRoot.iconbitmap('python bootcamp//src//Icon.ico')
...
def Return():
    ...
    if len(returnID) == 3:
        try:
            dicReturn = {}
            booksInfoReturn = getbooksinfo('python bootcamp//src//BookList.txt' , dicReturn)
...
def AddBook():
    ...
    bookAddRoot.iconbitmap('python bootcamp//src//Icon.ico')
...
def Add():
    ...
    if len(bookTitle) != 0:
        if len(bookAuthor) != 0:
            lst1 = []
            bookInfoList = gettitleandauthor('python bootcamp//src//BookList.txt' , lst1)
            ...
            if bookInfo in bookInfoList:
                ...
                bookID = getlastid('python bootcamp//src//BookList.txt')
                if 99 > int(bookID) >= 9:
                ...
                bookList = open('python bootcamp//src//BookList.txt' , 'a')
...
def DeleteBook(): 
    ...
    try:
        ...
        bookDeleteRoot.iconbitmap('python bootcamp//src//Icon.ico')
...
def Delete():
    ...
    if len(deleteID) == 3:
        try:
            dicDelete = {}
            booksInfoDelete = getbooksinfo('python bootcamp//src//BookList.txt' , dicDelete)
...
library_app.iconbitmap('python bootcamp//src//Icon.ico')

#Background Image

backgroundImage =Image.open('python bootcamp//src//Background.jpg')
